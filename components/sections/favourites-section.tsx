		...
		<>
			<div className="pb-10">
				...
				<div className="flex flex-col gap-10 lg:px-30 px-8">
					...
					<motion.div className="col-span-1 h-[250px] rounded-2xl overflow-hidden border border-white/10 shadow-2xl relative">
					...
					<motion.div className="col-span-1 md:col-span-3 h-[250px] rounded-2xl overflow-hidden border border-white/10 shadow-2xl relative">
